...
// async function myAjaxAsync(obj) {
//     let defaults = {
//         type: "get",
//         url: "#",
//         dataType: "json",
...
async function myAjaxAsync(obj, fun) {
    let value = await myAjaxPromise(obj)
    fun(value)
}
...
myAjaxPromise({
    ...
    console.log(" promise版ajax " , value);
})
